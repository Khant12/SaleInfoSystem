...
public class MergeSortName {
    ...
    public static void mergeSortProductList(List<Product> productList) {
        long startTime = System.currentTimeMillis(); // Start time function
        
        mergeSortProductList(productList, 0, productList.size() - 1);
    ...
    private static void mergeSortProductList(List<Product> productList, int left, int right) {
        if (left < right) {
    ...
    private static void mergeProduct(List<Product> productList, int left, int mid, int right) {
